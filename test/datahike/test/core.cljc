...
#?(:cljs (defmethod t/report [::t/default :error]
           [m]
...
#?(:cljs (defmethod t/report [::t/default :end-run-tests]
           [m]
...
;; utils
#?(:clj (defmethod t/assert-expr 'thrown-msg?
          [msg form]
...
#?(:clj (alter-var-root #'kaocha.stacktrace/*stacktrace-filters* (constantly ["java." "clojure." "kaocha." "orchestra."])))
...
(deftest test-protocols
  (let [schema {:aka {:db/cardinality :db.cardinality/many}}
    ...
    (is (= 6 (count db)))
    (is (= (set (seq db))
           #{(d/datom 1 :aka "IV") (d/datom 1 :aka "Terrible") (d/datom 1 :name "Ivan") (d/datom 2 :age 37) (d/datom 2 :name "Petr")
             (d/datom 2 :huh? false)}))
  ))
