...
(deftest test-diff
  (is (= [[(d/datom 1 :b 2) (d/datom 1 :c 4) (d/datom 2 :a 1)] [(d/datom 1 :b 3) (d/datom 1 :d 5)] [(d/datom 1 :a 1)]]
         (clojure.data/diff
...
(deftest empty-db-with-schema
  (testing "Test old write schema"
    ...
    (is (= {:name     {:db/cardinality :db.cardinality/one
